...
use serjazz\modules\UserManagement\components\UserIdentity;
...
class User extends UserIdentity
{
    ...
    /**
     * Generating hash for make relation beetween user and company
     *
     * @return string
     */
    public function generateChash(){
        return hash('ripemd128',$this->username.'Bn5Tg'.$this->email.'rtGh'.mt_rand(1101,5987).'lJ');
    }

    /**
     * Validate relation hash and return user id if it exist
     *
     * @param string $hash
     * @return bool
     */

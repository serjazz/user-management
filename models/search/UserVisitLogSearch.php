...
namespace serjazz\modules\UserManagement\models\search;
...
/**
 * UserVisitLogSearch represents the model behind the search form about `serjazz\modules\UserManagement\models\UserVisitLog`.
 */
